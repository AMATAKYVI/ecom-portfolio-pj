    ...
    <main className="mx-auto max-w-7xl space-y-6 px-4 py-8">
      ...
      {hasDataError ? (
        <p className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700">
          Search is temporarily unavailable. Check your production database
          configuration.
        </p>
      ) : null}
      {query ? (
        ...
        <p className="rounded-xl border border-dashed border-slate-300 p-8 text-center text-slate-500">
          Start by typing a query above, or explore the{' '}
          <Link href="/products" className="font-semibold text-cyan-700">
            products catalog
          </Link>
          .
        </p>
